...
# import h5py
# # 读取文件
# with h5py.File('ED_illinois200_data_for_training_PINN.mat', 'r') as mat:
...
#
# torch.save(model.state_dict(), 'D:\PycharmProjects\pythonProject\Illinois_pinn-based-uc_and_ed20260416\ed_pinns_LOLP_test_2000.pt')
...
with pd.ExcelWriter('illinois200_pinn_training_LOLP_output_test_2000.xlsx') as writer:
