...
#
# torch.save(model.state_dict(), 'D:\PycharmProjects\pythonProject\Illinois_pinn-based-uc_and_ed20260416\ed_conventional_resnet_test_2000.pt')

model = PINNs_CONV(in_dim=Nb+Ng, hidden_dim=hidden_dim, out_dim=2).to(device)
model.load_state_dict(torch.load('D:\PycharmProjects\pythonProject\Illinois_pinn-based-uc_and_ed20260416\ed_conventional_resnet_test_2000.pt'))
...
with pd.ExcelWriter('D:\PycharmProjects\pythonProject\Illinois_pinn-based-uc_and_ed20260416\illinois200_conventional_resnet_training_output_test_2000.xlsx') as writer:
