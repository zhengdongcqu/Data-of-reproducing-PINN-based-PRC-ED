...
print(model)
# model.load_state_dict(torch.load('D:\PycharmProjects\pythonProject\RTS79_pinn-based-uc_and_ed20260309\ed_pinns_EDNS_test_5000.pt'))
...
#
# torch.save(model.state_dict(), 'D:\PycharmProjects\pythonProject\Illinois_pinn-based-uc_and_ed20260416\ed_pinns_EDNS_test_500_TL_cmp.pt')

model = PINNs_CONV(in_dim=Nb+Ng, hidden_dim=hidden_dim, out_dim=1, failure_matrix=failure_matrix, prob_failure=prob_failure, type=1).to(device)
model.load_state_dict(torch.load('D:\PycharmProjects\pythonProject\Illinois_pinn-based-uc_and_ed20260416\ed_pinns_EDNS_test_500_TL_cmp.pt'))
...
with pd.ExcelWriter('illinois200_pinn_training_EDNS_output_test_500_TL_cmp.xlsx') as writer:
