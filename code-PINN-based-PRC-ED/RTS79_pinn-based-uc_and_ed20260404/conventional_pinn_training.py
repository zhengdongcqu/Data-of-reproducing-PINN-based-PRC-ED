...
#
# torch.save(model.state_dict(), 'D:\PycharmProjects\pythonProject\RTS79_pinn-based-uc_and_ed20260404/ed_conventional_pinns_test_5000_seed2.pt')

model = PINNs_CONV(in_dim=Nb+Ng, hidden_dim=hidden_dim, out_dim=2).to(device)
model.load_state_dict(torch.load('D:\PycharmProjects\pythonProject\RTS79_pinn-based-uc_and_ed20260404/ed_conventional_pinns_test_5000_seed2.pt'))
...
with pd.ExcelWriter('D:\PycharmProjects\pythonProject\RTS79_pinn-based-uc_and_ed20260404\RTS79_conventional_pinn_training_output_test_5000_seed2.xlsx') as writer:
