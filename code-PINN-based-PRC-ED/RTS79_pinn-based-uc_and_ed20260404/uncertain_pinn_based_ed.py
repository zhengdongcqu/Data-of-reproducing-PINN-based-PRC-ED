...
model_edns.load_state_dict(torch.load('D:\PycharmProjects\pythonProject\RTS79_pinn-based-uc_and_ed20260404\ed_pinns_EDNS_test_5000.pt'))
...
model_lolp.load_state_dict(torch.load('D:\PycharmProjects\pythonProject\RTS79_pinn-based-uc_and_ed20260404\ed_pinns_LOLP_test_5000.pt'))
for param in model_lolp.parameters():
    param.requires_grad = False

mat = scipy.io.loadmat('D:\PycharmProjects\pythonProject\RTS79_pinn-based-uc_and_ed20260404\RTS79_rolling_ed_K1.mat')
...
filename = 'RTS79_uncertain_pinn_based_ed_results_K1.xlsx'
