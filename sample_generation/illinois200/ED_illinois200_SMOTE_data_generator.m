...
% 
% save('illinois200_da_result.mat','da_result')

load('illinois200_da_result.mat')
UG_da=da_result{1};
...
EDNS_target = quantile(EDNS_vector_gs(num), 0.50);
LOLP_target = quantile(LOLP_vector_gs(num), 0.50);
...
save('ED_illinois200_data_for_testing_PINN.mat')
